...
{\em saved\+Instance\+State} & Android default \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em menu} & The menu created by android \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em event} & Filtered gesture movement \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em event1} & Gesture event \\
\hline
{\em event2} & Gesture event \\
\hline
{\em velocity\+X} & Length of the swipe in the X-\/direction \\
\hline
{\em velocity\+Y} & distance\+Y Length of the swipe in the Y-\/direction \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em item} & Items in the menu to be selected \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
{\em e2} & Gesture event \\
\hline
{\em distance\+X} & Length of the swipe in the X-\/direction \\
\hline
{\em distance\+Y} & Length of the swipe in the Y-\/direction \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em view} & \hyperlink{classcom_1_1chopin_1_1Song}{Song} list view. \\
\hline
\end{DoxyParams}
